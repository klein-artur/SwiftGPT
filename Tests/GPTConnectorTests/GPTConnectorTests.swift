...
//
//    func testShouldFunctionCallsLastMessage() async throws {
//        // given
//        var numberOfCalls = 0
//        let apiConnectorMock = OpenAIConnectorMock { chat in
//            defer {
...
//
//        // when
//        let result = try await sut.chatLastMessage(context: inputChat, onFunctionCall: functionCallback)
//
//        // then
//        XCTAssertEqual(result?[0].content, "function result2")
//        XCTAssertEqual(numberOfCalls, 3)
//        XCTAssertEqual(functionCallbackNumber, 2)
//    }
