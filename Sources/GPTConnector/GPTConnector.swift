...
public extension GPTConnector {
    func chat(
        ...
        return try await self.chat(context: context, onMessagesReceived: { (choices, _) in choices[0] }, onFunctionCall: { (_, _) in throw GPTConnectorError.noFunctionHandling })
    }
    ...
    func chat(
        ...
        return try await self.chat(context: context, onMessagesReceived: onMessagesReceived, onFunctionCall: { (_, _) in throw GPTConnectorError.noFunctionHandling })
    }
